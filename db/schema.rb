...
ActiveRecord::Schema.define(version: 2021_11_15_101806) do
  ...
  create_table "delayed_imports", force: :cascade do |t|
    t.string "name"
    t.string "file_path"
    t.string "state"
    t.string "project_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["project_id"], name: "index_delayed_imports_on_project_id"
  end
  ...
  create_table "issue_histories", force: :cascade do |t|
    ...
    t.index ["jira_user_id"], name: "index_issue_histories_on_jira_user_id"
    t.index ["project_id"], name: "index_issue_histories_on_project_id"
  end
  ...
  create_table "projects", id: :string, force: :cascade do |t|
    ...
    t.string "state"
    t.string "jira_url"
    t.string "status_field", default: "State"
